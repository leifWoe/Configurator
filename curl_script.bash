...
curl -X GET -H "Content-Type: application/json" -H "Authorization: Token token=h_sHaMvYVfPRRJ_LdgW3F3018xsh44Iy2iox6onvIbhsazdQIRBODWgiDBeB_30E" https://support.speedbone.de/api/v1/groups/1